...
function InitForm() {
    layui.use(['form'], function () {
        ...
        form.on('switch(SwitchShuttle)', function (data) { 
            ...
            if (flag) {
                //obj.show();
                $("#MeetPosition").removeAttr("readonly");
                $("#MeetPosition").css("background", "#fff");
                $("#SendPosition").removeAttr("readonly");
                $("#SendPosition").css("background", "#fff");
            } else {
                //obj.hide();
                $("#MeetPosition").attr("readonly");
                $("#MeetPosition").css("background", "#ccc");
                $("#MeetPosition").val("");
                $("#SendPosition").attr("readonly");
                $("#SendPosition").css("background", "#ccc");
                $("#SendPosition").val("");
            }
            calcTotalMoney();
        });
